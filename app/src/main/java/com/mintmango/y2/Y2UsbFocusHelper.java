 ...
 * Y2UsbFocusHelper: poll window focus while a host is connected and reclaim it with
 * moveTaskToFront + a HOME intent when SystemUI steals it.
 */
public final class Y2UsbFocusHelper {

    private static final String TAG = "Y2UsbFocusHelper";
    ...
    public Y2UsbFocusHelper(Activity activity) {
    ...
    private void bringToFrontAsync() {
        new Thread(this::bringToFront, "Y2UsbFocusReclaim").start();
    }
