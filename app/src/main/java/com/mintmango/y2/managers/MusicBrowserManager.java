...
//                                        Toast.makeText(a, "Loaded " + allAudioInFolder.size() + " songs!", Toast.LENGTH_SHORT).show();
                                        com.mintmango.y2.managers.AudioPlayerManager.getInstance().playTrackList(allAudioInFolder, 0); // Start playing right from track 0!
...
//                Button b = createListButton("🖼 " + img.getName());
                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        android.content.Intent intent =
                                new android.content.Intent(a, com.mintmango.y2.VideoPlayerActivity.class);
            ...
            for (final File audio : audioFiles) {
                ...
                if (a.isAudiobookLibraryMode || a.currentBrowserMode == a.BROWSER_AUDIOBOOKS) {
                    com.mintmango.y2.db.LibraryCacheDb.Bookmark bm = a.libraryCacheDb.getBookmark(audio.getAbsolutePath());
                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (a.currentBrowserMode == a.BROWSER_AUDIOBOOKS) {
                            com.mintmango.y2.managers.AudiobookManager.getInstance(a).setupBookPlaylist(a, audio, a.currentFolder);
                        } else {
                            com.mintmango.y2.managers.AudioPlayerManager.getInstance().setupFolderPlaylist(audio, a.currentFolder);
                        }
