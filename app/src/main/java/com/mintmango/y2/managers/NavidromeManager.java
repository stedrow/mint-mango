...
import com.mintmango.y2.subsonic.SubsonicAlbum;
import com.mintmango.y2.subsonic.SubsonicArtist;
import com.mintmango.y2.subsonic.SubsonicClient;
import com.mintmango.y2.subsonic.SubsonicSong;
...
public class NavidromeManager {
    ...
    public void updateNavidromeQualityInfo(MainActivity a, com.mintmango.y2.managers.AudioPlayerManager am) {
        if (am.navidromePlaylist.isEmpty()) return;
        com.mintmango.y2.subsonic.SubsonicSong song = am.navidromePlaylist.get(am.navidromeIndex);
    ...
    public void buildNavidromeUI(MainActivity a) {
        com.mintmango.y2.subsonic.SubsonicClient client = com.mintmango.y2.subsonic.SubsonicClient.getInstance();
        ...
        if (a.navidromeBrowseDepth == a.NAV_ARTISTS) {
            ...
            client.getArtists(new com.mintmango.y2.subsonic.SubsonicClient.Callback<java.util.List<com.mintmango.y2.subsonic.SubsonicArtist>>() {
                @Override
                public void onSuccess(java.util.List<com.mintmango.y2.subsonic.SubsonicArtist> artists) {
            ...
            client.getArtist(a.selectedNavidromeArtist.id, new com.mintmango.y2.subsonic.SubsonicClient.Callback<java.util.List<com.mintmango.y2.subsonic.SubsonicAlbum>>() {
                @Override
                public void onSuccess(java.util.List<com.mintmango.y2.subsonic.SubsonicAlbum> albums) {
            ...
            client.getAlbum(selectedNavidromeAlbum.id, new com.mintmango.y2.subsonic.SubsonicClient.Callback<java.util.List<com.mintmango.y2.subsonic.SubsonicSong>>() {
                @Override
                public void onSuccess(java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs) {
    ...
    public boolean navidromeArtistListsEqual(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicArtist> listA,
                                              java.util.List<com.mintmango.y2.subsonic.SubsonicArtist> b) {
        if (listA.size() != b.size()) return false;
        for (int i = 0; i < listA.size(); i++) {
            com.mintmango.y2.subsonic.SubsonicArtist x = listA.get(i), y = b.get(i);
    ...
    public void buildNavidromeArtistsUI(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicArtist> artists) {
        buildNavidromeArtistsUI(a, artists, null);
    }

    public void buildNavidromeArtistsUI(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicArtist> artists, String focusLetter) {
        a.lastNavidromeArtists = artists;
        a.isNavidromeLetterView = false;
        a.containerNavidromeItems.removeAllViews();
        if (artists.isEmpty()) {
        ...
        for (final com.mintmango.y2.subsonic.SubsonicArtist artist : artists) {
    ...
    public void buildNavidromeLetterIndexUI(MainActivity a) {
        ...
        for (com.mintmango.y2.subsonic.SubsonicArtist artist : a.lastNavidromeArtists) {
    ...
    public void buildNavidromeAlbumsUI(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicAlbum> albums) {
        a.containerNavidromeItems.removeAllViews();
        if (albums.isEmpty()) {
            showNavidromeMessage(a, "", "No albums found for this artist.");
            return;
        }
        for (final com.mintmango.y2.subsonic.SubsonicAlbum album : albums) {
    ...
    public void buildNavidromeSongsUI(MainActivity a, final java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs) {
        a.containerNavidromeItems.removeAllViews();
        if (songs.isEmpty()) {
        ...
        btnDlAll.setOnLongClickListener(new View.OnLongClickListener() {
            @Override public boolean onLongClick(View v) {
                int downloaded = 0;
                for (com.mintmango.y2.subsonic.SubsonicSong s : songs) if (s.isDownloaded()) downloaded++;
                if (downloaded == 0) {
                        ...
                        new Runnable[]{
                                new Runnable() {
                                    @Override public void run() {
                                        for (com.mintmango.y2.subsonic.SubsonicSong s : songs) deleteNavidromeDownload(a, s);
        ...
        for (int i = 0; i < songs.size(); i++) {
            final com.mintmango.y2.subsonic.SubsonicSong song = songs.get(i);
            final int index = i;
            ...
            btn.setOnLongClickListener(new View.OnLongClickListener() {
                @Override public boolean onLongClick(View v) {
                    if (song.isDownloaded()) {
                        ...
                        java.util.List<com.mintmango.y2.subsonic.SubsonicSong> single =
                                new java.util.ArrayList<com.mintmango.y2.subsonic.SubsonicSong>();
                        single.add(song);
    ...
    public String navidromeSongTitleLabel(MainActivity a, com.mintmango.y2.subsonic.SubsonicSong song) {
    ...
    public void refreshNavidromeSongLabels(MainActivity a) {
        ...
        for (int i = 0; i < a.containerNavidromeItems.getChildCount(); i++) {
            ...
            if (child instanceof LinearLayout && child.getTag() instanceof com.mintmango.y2.subsonic.SubsonicSong) {
                TextView tvTitle = (TextView) ((LinearLayout) child).getChildAt(0);
                tvTitle.setText(navidromeSongTitleLabel(a, (com.mintmango.y2.subsonic.SubsonicSong) child.getTag()));
            }
        }
    }

    public void playNavidromeAlbum(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs, int startIndex) {
        ...
        if (com.mintmango.y2.cast.CastManager.getInstance().isCasting()) {
            am.markNavidromeModeForCast();
            com.mintmango.y2.cast.CastManager.getInstance().reloadCurrentTrack(true);
        } else {
            com.mintmango.y2.subsonic.SubsonicSong song = songs.get(startIndex);
            String url = com.mintmango.y2.subsonic.SubsonicClient.getInstance().getStreamUrl(song.id);
    ...
    public void downloadNavidromeAlbum(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs) {
        showNavidromeDownloadQualityDialog(a, songs);
    }

    public void showNavidromeDownloadQualityDialog(MainActivity a, final java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs) {
        if (songs == null || songs.isEmpty()) return;
    ...
    public void showNavidromeDeleteDialog(MainActivity a, final com.mintmango.y2.subsonic.SubsonicSong song) {
    ...
    public boolean deleteNavidromeDownload(MainActivity a, com.mintmango.y2.subsonic.SubsonicSong song) {
    ...
    public void enqueueNavidromeDownloads(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs, boolean transcoded) {
    ...
    private void enqueueNavidromeDownloadsWithConfirm(final MainActivity a,
            final java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs, final boolean transcoded, boolean force) {
    ...
    public EnqueueResult enqueueNavidromeDownloadsCore(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs, boolean transcoded) {
     ...
     */
    public EnqueueResult enqueueNavidromeDownloadsCore(MainActivity a, java.util.List<com.mintmango.y2.subsonic.SubsonicSong> songs, boolean transcoded, boolean force) {
        ...
        long neededBytes = 0;
        for (com.mintmango.y2.subsonic.SubsonicSong song : songs) {
        ...
        try {
            if (navidromeDownloadWakeLock == null) {
                ...
                navidromeDownloadWakeLock = pm.newWakeLock(
                        android.os.PowerManager.PARTIAL_WAKE_LOCK, "y2:NavidromeDownload");
            ...
            if (navidromeDownloadWifiLock == null) {
                ...
                navidromeDownloadWifiLock = wm.createWifiLock(
                        android.net.wifi.WifiManager.WIFI_MODE_FULL_HIGH_PERF, "y2:NavidromeDownload");
        ...
        try {
            ...
            if (navidromeStreamWakeLock == null) {
                ...
                navidromeStreamWakeLock = pm.newWakeLock(
                        android.os.PowerManager.PARTIAL_WAKE_LOCK, "y2:NavidromeStream");
            ...
            if (navidromeStreamWifiLock == null) {
                ...
                navidromeStreamWifiLock = wm.createWifiLock(
                        android.net.wifi.WifiManager.WIFI_MODE_FULL_HIGH_PERF, "y2:NavidromeStream");
    ...
    public void processNextNavidromeDownload(MainActivity a) {
        ...
        final com.mintmango.y2.subsonic.SubsonicSong song = item != null ? item.song : null;
        if (song == null) {
    ...
    public void startNavidromeDownload(MainActivity a, final NavidromeDownloadItem item, final com.mintmango.y2.subsonic.SubsonicSong song) {
        ...
        com.mintmango.y2.subsonic.SubsonicClient.getInstance().downloadSong(song.id, savePath, item.transcoded,
                new com.mintmango.y2.subsonic.SubsonicClient.DownloadCallback() {
                    @Override
    ...
    public void logNavidromeDownloadError(MainActivity a, com.mintmango.y2.subsonic.SubsonicSong song, String message) {
        try {
    ...
    public void registerDownloadedSongInLibrary(MainActivity a, com.mintmango.y2.subsonic.SubsonicSong song, String path) {
        try {
            ...
            if (a.libraryCacheDb != null) {
                a.libraryCacheDb.upsert(new com.mintmango.y2.db.LibraryCacheDb.CachedSong(
    ...
    public void cacheNavidromeCoverForDownloadedTrack(MainActivity a, final com.mintmango.y2.subsonic.SubsonicSong song,
        ...
        com.mintmango.y2.subsonic.SubsonicClient.getInstance().fetchCoverArt(song.coverArtId, 320, cacheFile,
                new com.mintmango.y2.subsonic.SubsonicClient.Callback<String>() {
                    @Override
    ...
    public void loadNavidromeCoverArt(MainActivity a, final com.mintmango.y2.subsonic.SubsonicSong song) {
