...
public class ConnectivityScreenManager {
    ...
    private static final int[] NOISE_MODES = {
            com.mintmango.y2.AapService.NOISE_OFF,
            com.mintmango.y2.AapService.NOISE_ANC,
            com.mintmango.y2.AapService.NOISE_TRANSPARENCY,
            com.mintmango.y2.AapService.NOISE_ADAPTIVE
    };
    ...
    private static String batteryLabel(int percent, boolean charging) {
        if (percent == com.mintmango.y2.AapService.BATTERY_UNKNOWN) return "--";
    ...
    private void showAirPodsInfo(MainActivity a) {
        com.mintmango.y2.AapService.AapState st = com.mintmango.y2.AapService.getLastState();
        String[] labels = {
    ...
    public void addPairedBluetoothItemToUI(MainActivity a, final BluetoothDevice device) {
        ...
        boolean isConnected = com.mintmango.y2.managers.BluetoothAudioManager.getInstance().isA2dpConnectedTo(device);
        ...
        final boolean hasAapInfo = isConnected && com.mintmango.y2.AapService.isConnected();
        ...
        btnUnpair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    com.mintmango.y2.managers.BluetoothAudioManager.getInstance().forgetTargetIfMatches(device);
