package com.mintmango.y2.subsonic;
...
public class SubsonicClient {
    ...
    private com.mintmango.y2.db.LibraryCacheDb libraryCacheDb;
    ...
    public void loadSettings(Context ctx) {
        ...
        if (libraryCacheDb == null) libraryCacheDb = new com.mintmango.y2.db.LibraryCacheDb(appContext);
    ...
    public void saveSettings(Context ctx, String url, String user, String pass) {
        ...
        if (changed) {
            configVersion++;
            if (libraryCacheDb == null) libraryCacheDb = new com.mintmango.y2.db.LibraryCacheDb(ctx.getApplicationContext());
