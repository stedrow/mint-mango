 ...
 * it, unlike {@link com.mintmango.y2.subsonic.NavidromeProxyServer} which is localhost-only.
 *
 * Deliberately separate from {@link com.mintmango.y2.Y2WebServer}: that server is sandboxed
